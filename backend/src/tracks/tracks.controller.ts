...
export class TracksController {
  ...
  @ThrottleOverride("TRACK_CREATION") // 5 requests per minute
  ...
  @ThrottleOverride("PUBLIC_READ") // 200 requests per minute
  ...
  @ThrottleOverride("PUBLIC_READ") // 200 requests per minute
  @ApiOperation({
    summary: "Get all public tracks with pagination and filtering",
  })
  ...
  @ApiResponse({
    status: 200,
    description: "Tips added successfully",
    type: Track,
  })
  @ApiResponse({ status: 404, description: "Track not found" })
  addTips(
